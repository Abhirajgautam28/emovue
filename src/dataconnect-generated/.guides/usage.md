...
```ts
import { useCreateUser, useGetUser, useCreateMessage, useListMessagesByConversation } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListMessagesByConversation(listMessagesByConversationVars);
...
```js
import { createUser, getUser, createMessage, listMessagesByConversation } from '@dataconnect/generated';
...
// Operation ListMessagesByConversation:  For variables, look at type ListMessagesByConversationVars in ../index.d.ts
