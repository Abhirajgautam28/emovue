...
const listMessagesByConversationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.listMessagesByConversationRef = listMessagesByConversationRef;

exports.listMessagesByConversation = function listMessagesByConversation(dcOrVars, vars) {
